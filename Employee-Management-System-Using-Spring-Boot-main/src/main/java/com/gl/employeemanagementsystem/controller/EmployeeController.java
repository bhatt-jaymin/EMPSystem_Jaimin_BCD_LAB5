...
public class EmployeeController {
	...
	public String viewHomePage(Model model) {
		...
		// This attribute "listEmployees" to perform server-side rendering of the HTML
		// with using Thymeleaf.
	...
	public String showUpdateForm(@PathVariable Long id, Model model) {
		...
		// set this attribute "employee" to perform server-side rendering of the HTML
		// with using Thymeleaf.
		// set employee data as "employee"
		model.addAttribute("employee", employee);
